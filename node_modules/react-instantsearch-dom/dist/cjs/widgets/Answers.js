...
function Answers(_ref2) {
  var searchClient = _ref2.searchClient,
      ...
      extraParameters = (0, _objectWithoutProperties2.default)(_ref2, _excluded);

  var _useAnswers = (0, _useAnswers2.default)(_objectSpread({
  ...
  return /*#__PURE__*/_react.default.createElement(AnswersComponent, {
    hits: hits,
    isLoading: isLoading
  });
}
