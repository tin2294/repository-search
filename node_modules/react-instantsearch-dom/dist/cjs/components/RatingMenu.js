  ...
  (0, _createClass2.default)(RatingMenu, [{
    ...
    value: function buildItem(_ref) {
      ...
      for (var icon = 0; icon < max; icon++) {
        ...
        icons.push([/*#__PURE__*/_react.default.createElement("svg", {
          key: icon,
      ...
      }, onClickHandler), icons, /*#__PURE__*/_react.default.createElement("span", {
        className: cx('label'),
        "aria-hidden": "true"
      }, translate('ratingLabel')), ' ', /*#__PURE__*/_react.default.createElement("span", {
        className: cx('count')
      }, count)));
    }
  }, {
